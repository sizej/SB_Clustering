...
wine$Type <- scale(as.numeric(wine$Type), scale = TRUE)
...
# Answer - According to the majority rule, the best number of clusters is  2
...
# fit.km <- kmeans( ... )
# Answer - Going with 3....
fit.km <- kmeans(wine, centers = 2, iter.max = 1000)
...
# also returns 3 groups (47,69,62).  I'd say it's no better than the existing
# Type classification.
